...
{   
    ...
    {if(isset($this->$propiedad)){return $this->$propiedad;}else{echo "No existe la propiedad {$this->$propiedad}";}}
    
    function __set($propiedad,$valor)
    {
  if(isset($this->$propiedad)){$this->$propiedad = $valor;}else {echo "No existe la propiedad {$propiedad}";}
    }
}